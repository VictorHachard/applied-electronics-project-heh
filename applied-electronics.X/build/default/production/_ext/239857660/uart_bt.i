...
# 2 "<built-in>" 2
# 1 "../drivers/uart_bt.c" 2





# 1 "../drivers/uart_bt.h" 1
...
# 10 "../drivers/uart_bt.h" 2
# 1 "../drivers/../core/types.h" 1
# 16 "../drivers/../core/types.h"
typedef struct {
  uint8_t hour, min;
  uint8_t day, month;
} rtc_time_t;
# 34 "../drivers/../core/types.h"
typedef struct {
  int32_t pressure_pa;
  int16_t temp_c_x100;
} bmp280_data_t;
# 52 "../drivers/../core/types.h"
typedef struct {
  uint16_t rh_x100;
  int16_t temp_c_x100;
} sht30_data_t;
# 68 "../drivers/../core/types.h"
typedef struct {
  int16_t t_c_x100;
  uint16_t rh_x100;
  int32_t p_pa;
...
# 8 "../drivers/uart_bt.c" 2
# 1 "../drivers/../core/board.h" 1
# 28 "../drivers/../core/board.h"
...
app_err_t uart_bt_init(uint32_t baud) {
    ...
    uint16_t brg = (uint16_t)((64000000UL / (4UL * baud)) - 1);
    U2BRG = brg;
