...
# 1 "../app/../drivers/i2c_bus.h" 1
# 15 "../app/../drivers/i2c_bus.h"
...
# 1 "../app/../drivers/spi_bus.h" 1
# 15 "../app/../drivers/spi_bus.h"
app_err_t spi_bus_init();
# 19 "../app/app_main.c" 2

# 1 "../app/../drivers/uart_pc.h" 1
# 13 "../app/../drivers/uart_pc.h"
...
# 1 "../app/../drivers/uart_bt.h" 1
# 13 "../app/../drivers/uart_bt.h"
...
void app_main_loop_tmp(void) {
    ...
    while (1) {
        ...
        if (g_tick_counter % 10 == 0 &&
            ...
            uint8_t period_s = current_cfg.sample_period_min;
...
void test_dl_setup(void)
{
    ...
    rtc_time_t start = {0, 0, 14, 15, 12, 25};
    ...
    err = dl_set_sample_period_min(5);
    if (err != APP_OK) {
        Lcd_Clear();
        sprintf(buf, "ERR: %d", err);
        Lcd_Write_String(buf);
    ...
    Lcd_Clear();
    Lcd_Set_Cursor(0, 0);
    Lcd_Write_String("Period set: 5min");
    Lcd_Set_Cursor(1, 0);
    Lcd_Write_String("OK");
    _delay((unsigned long)((1000)*(64000000UL/4000.0)));
